const templateAreaChart = document.createElement('template');
templateAreaChart.innerHTML = `
<style>
:host {
    display: block;
}
...
class AreaChart extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadowRoot.appendChild(templateAreaChart.content.cloneNode(true));
    }
    ...
    async renderChart() {
        ...
        const chart = new google.visualization.AreaChart(this.shadowRoot.querySelector('div'));
