...
class PieChart extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadowRoot.appendChild(templatePieChart.content.cloneNode(true));
    }
    ...
    async renderChart() {
        ...
        const chart = new google.visualization.PieChart(this.shadowRoot.querySelector('div'));
